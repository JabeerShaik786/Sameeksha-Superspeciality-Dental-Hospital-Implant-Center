    ...
    <section id="blog" className="py-24 bg-[#F8FAFC] relative overflow-hidden">
      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-12">
        ...
        <div className="flex flex-col items-center text-center max-w-2xl mx-auto mb-16">
          <span className="text-sm font-extrabold text-[#0AA8DE] uppercase tracking-widest mb-3 flex items-center gap-1.5">
            <BookOpen className="w-4 h-4 text-[#0AA8DE]" />
            Dental Health Blog
          </span>
          ...
          <div className="h-1 w-16 bg-[#E71B1E] rounded-full mt-6" />
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {ARTICLES.map((article, idx) => (
            <motion.div
              ...
              whileHover={{ y: -6 }}
              className="group rounded-3xl bg-white border border-borders/50 hover:border-[#0AA8DE] overflow-hidden shadow-lg shadow-[#0AA8DE]/[0.03] hover:shadow-xl hover:shadow-[#0AA8DE]/10 transition-all duration-300 flex flex-col justify-between cursor-pointer"
            >
              <div>
                ...
                <div className="relative w-full aspect-[16/10] overflow-hidden bg-slate-100">
                  ...
                  />
                  {/* Category Pill */}
                  <span className="absolute top-4 left-4 text-[9px] font-extrabold bg-[#0AA8DE] text-white px-3 py-1 rounded-full uppercase tracking-wider shadow-sm">
                    {article.category}
                  </span>
                </div>
                ...
                <div className="p-6 md:p-8 text-left">
                  <h3 className="font-heading font-extrabold text-lg md:text-xl text-dark-text tracking-tight mb-3 leading-snug group-hover:text-[#0AA8DE] transition-colors duration-200">
                    {article.title}
                  </h3>
              ...
              <div className="px-6 md:px-8 pb-6 md:pb-8 pt-0 flex justify-start">
                <button className="text-sm font-bold text-[#0AA8DE] group-hover:text-[#088ec0] flex items-center gap-1.5 transition-colors duration-200">
                  <span>Read Article</span>
                  <ArrowRight className="w-4 h-4 text-[#E71B1E] transform translate-x-0 group-hover:translate-x-1.5 transition-transform duration-200" />
                </button>
              </div>
            </motion.div>
          ))}
