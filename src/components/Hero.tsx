...
export default function Hero() {
  ...
  return (
    <section
      id="home"
      className="relative w-full min-h-[580px] lg:min-h-[660px] flex items-center pt-28 pb-32 overflow-hidden bg-[#e4f6fc]"
    >
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-[#d9f2fa] via-[#e5f6fc]/95 md:via-[#e5f6fc]/85 via-45% to-transparent to-75% pointer-events-none" />
      </div>
