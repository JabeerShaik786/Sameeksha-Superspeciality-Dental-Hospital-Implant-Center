...
export default function Services() {
  return (
    <section
      ...
      style={{
        background: "linear-gradient(175deg, #a81013 0%, #E71B1E 50%, #800a0c 100%)",
      }}
    >
      <div className="max-w-[1360px] mx-auto px-4 sm:px-6 md:px-12 relative z-10 text-center">
        ...
        <div className="inline-block mb-8 lg:mb-10">
          ...
          <div className="w-16 h-1 bg-white mx-auto mt-2.5 rounded-full" />
        </div>
        ...
        <div className="relative max-w-[1060px] mx-auto min-h-[540px] flex items-center justify-center">
          ...
          <div className="hidden lg:block w-full h-[540px] relative">
            ...
            >
              ...
              <div className="w-10 h-10 rounded-full bg-white text-[#E71B1E] border-2 border-white shadow-md flex items-center justify-center shrink-0 hover:bg-[#0AA8DE] hover:text-white transition-colors duration-200">
          ...
          <div className="lg:hidden flex flex-col items-center gap-8 w-full">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full text-left">
              {[
                ...
                <div
                  key={i}
                  className="flex items-center gap-3 p-3 rounded-xl bg-white/15 border border-white/25 backdrop-blur-xs hover:bg-white/20 transition-all"
                >
                  <div className="w-9 h-9 rounded-full bg-white text-[#E71B1E] flex items-center justify-center shrink-0 shadow-xs">
